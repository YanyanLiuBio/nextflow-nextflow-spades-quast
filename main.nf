...
workflow {
    ...
    fq = Channel.fromFilePairs("s3://seqwell-fastq/${params.run}/{${params.plates}}/*_R{1,2}_001.fastq.gz", flat: true, checkIfExists: true)
    ...
    // ==== 4. Join FASTQ with metadata → (sample_id, fq1, fq2, ref_path) ====
